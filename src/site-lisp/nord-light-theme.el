;; nord-light-theme.el -- Adapted Nord themes

;;; Commentary:
;; Adapted from https://github.com/arcticicestudio/nord-emacs
...
(defcustom nord-comment-brightness 10
  "Custom comment color brightness with percentage adjustments from 0% - 20%.

  As of version 0.4.0, this variable is obsolete/deprecated and
  has no effect anymore and will be removed in version 1.0.0!
  The comment color brightness has been increased by 10% by
  default.  Please see
  https://github.com/arcticicestudio/nord-emacs/issues/73 for
  more details."
  :type 'integer
  :group 'nord-light)
...
(make-obsolete-variable
 ...
 "The custom color brightness feature has been deprecated and
  will be removed in version 1.0.0!  The comment color brightness
  has been increased by 10% by default.  Please see
  https://github.com/arcticicestudio/nord-emacs/issues/73 for
  more details."
 "0.4.0")
...
(defvar nord-theme--brightened-comments
  '("#4c566a" "#4e586d" "#505b70" "#525d73" "#556076" "#576279" "#59647c"
...
(defun nord-theme--brightened-comment-color (percent)
  "Return the brightened comment color for the given `PERCENT'.

  The value must be greater or equal to 0 and less or equal to
  20, otherwise the default 'nord3' color is used.  As of version
  0.4.0, this function is obsolete/deprecated and has no effect
  anymore and will be removed in version 1.0.0!  The comment
  color brightness has been increased by 10% by default.  Please
  see https://github.com/arcticicestudio/nord-emacs/issues/73 for
  more details."
...
;;;; +------------+
  (custom-theme-set-faces
   ...
   `(default ((,class (:foreground ,nord3 :background ,nord16))))
   ...
   `(whitespace-empty ((,class (:foreground ,nord3 :background ,nord16))))
   `(whitespace-hspace ((,class (:foreground ,nord3 :background ,nord16))))
   `(whitespace-indentation ((,class (:foreground ,nord3 :background ,nord16))))
   `(whitespace-line ((,class (:foreground ,nord3))))
   `(whitespace-newline ((,class (:foreground ,nord3 :background ,nord16))))
   `(whitespace-space ((,class (:foreground ,nord3 :background ,nord16))))
   `(whitespace-space-after-tab ((,class (:foreground ,nord3 :background ,nord16))))
   `(whitespace-space-before-tab ((,class (:foreground ,nord3 :background ,nord16))))
   `(whitespace-tab ((,class (:foreground ,nord3 :background ,nord4))))
   ...
   `(helm-match ((,class (:foreground ,nord11))))
   ...
   `(line-number ((,class (:foreground ,nord4))))
   `(line-number-current-line ((,class (:foreground ,nord0))))
   ...
   `(me-dired-dim-0 ((,class (:foreground "gray70"))))
   `(me-dired-dim-1 ((,class (:foreground ,nord4))))
