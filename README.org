...
*** Key logger
    ...
    builtin function =open-dribble-file= does exactly what I want.
    But be aware that it logs /everything/, literally, /everything/
    including your passwords.  So you may want to remove this section
...
(add-hook 'kill-emacs-hook
          (lambda ()
            (start-process-shell-command
             "keylog-async" nil
             (concat "rsync -r "
                     (expand-file-name "~/.emacs.d/keylog/") " "
                     (expand-file-name "~/Dropbox/dotfiles/emacs.d/keylog/")))))
    #+END_SRC
